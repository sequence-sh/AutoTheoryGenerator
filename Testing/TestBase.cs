...
public abstract class TestBase : IEnumerable<object[]>
{
    ...
    protected TestBase() => _testCaseDictionary =
        new Lazy<IReadOnlyDictionary<string, ITestBaseCase>>(() => MakeDictionary(TestCases));
    ...
    private static IReadOnlyDictionary<string, ITestBaseCase> MakeDictionary(
        IEnumerable<ITestBaseCase> testCases)
    {
