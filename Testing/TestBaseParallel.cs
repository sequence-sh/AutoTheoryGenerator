...
#pragma warning disable 8618 //The constructor must be parameterless. TestOutputHelper should be set directly from the public constructor.
        protected TestBaseParallel() => _testCaseDictionary = new Lazy<IReadOnlyDictionary<string, ITestBaseCaseParallel>>(() => MakeDictionary(TestCases));
#pragma warning restore 8618
        ...
        private static IReadOnlyDictionary<string, ITestBaseCaseParallel> MakeDictionary(IEnumerable<ITestBaseCaseParallel> testCases)
        {
